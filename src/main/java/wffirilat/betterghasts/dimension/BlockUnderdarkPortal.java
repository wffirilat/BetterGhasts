...
public class BlockUnderdarkPortal extends BlockBreakable {
	...
	protected BlockUnderdarkPortal(String p_i45411_1_, Material p_i45411_2_, boolean p_i45411_3_) {
		super(p_i45411_1_, p_i45411_2_, p_i45411_3_);
	}
	
	public String name = "underdarkPortal";
	...
	public boolean func_150000_e(World p_150000_1_, int p_150000_2_, int p_150000_3_, int p_150000_4_) {
		BlockUnderdarkPortal.Size size = new BlockUnderdarkPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
		BlockUnderdarkPortal.Size size1 = new BlockUnderdarkPortal.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_) {
		...
		BlockUnderdarkPortal.Size size = new BlockUnderdarkPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
		BlockUnderdarkPortal.Size size1 = new BlockUnderdarkPortal.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
		...
		public void func_150859_c() {
			for (int i = 0; i < this.field_150868_h; ++i) {
				...
				for (int l = 0; l < this.field_150862_g; ++l) {
					...
					this.field_150867_a.setBlock(j, i1, k, ModBlocks.portal, this.field_150865_b, 2);
				}
			}
		}
	}
