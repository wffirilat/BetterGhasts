...
public class GhastRage extends Block
{
    ...
    public void onBlockDestroyedByExplosion(World world, int x, int y, int z, Explosion explosion)
    {
        if (!world.isRemote)
        {
            PrimedGhastRage PrimedGhastRage = new PrimedGhastRage(world, (double)((float)x + 0.5F), (double)((float)y + 0.5F), (double)((float)z + 0.5F), explosion.getExplosivePlacedBy());
    ...
    public void explode(World world, int x, int y, int z, int doExplode, EntityLivingBase entity)
    {
        if (!world.isRemote)
        {
            ...
            {
                PrimedGhastRage PrimedGhastRage = new PrimedGhastRage(world, (double)((float)x + 0.5F), (double)((float)y + 0.5F), (double)((float)z + 0.5F), entity);
                world.spawnEntityInWorld(PrimedGhastRage);
