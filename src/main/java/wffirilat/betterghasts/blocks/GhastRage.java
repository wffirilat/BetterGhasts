...
import wffirilat.betterghasts.blocks.PrimedGhastRage;
...
public class GhastRage extends Block
{
    ...
    public void onBlockDestroyedByExplosion(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_, Explosion p_149723_5_)
    {
        ...
        {
            PrimedGhastRage PrimedGhastRage = new PrimedGhastRage(p_149723_1_, (double)((float)p_149723_2_ + 0.5F), (double)((float)p_149723_3_ + 0.5F), (double)((float)p_149723_4_ + 0.5F), p_149723_5_.getExplosivePlacedBy());
            PrimedGhastRage.fuse = p_149723_1_.rand.nextInt(PrimedGhastRage.fuse / 4) + PrimedGhastRage.fuse / 8;
            p_149723_1_.spawnEntityInWorld(PrimedGhastRage);
        }
    }
    ...
    public void func_150114_a(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_, EntityLivingBase p_150114_6_)
    {
        if (!p_150114_1_.isRemote)
        {
            if ((p_150114_5_ & 1) == 1)
            {
                PrimedGhastRage PrimedGhastRage = new PrimedGhastRage(p_150114_1_, (double)((float)p_150114_2_ + 0.5F), (double)((float)p_150114_3_ + 0.5F), (double)((float)p_150114_4_ + 0.5F), p_150114_6_);
                p_150114_1_.spawnEntityInWorld(PrimedGhastRage);
                p_150114_1_.playSoundAtEntity(PrimedGhastRage, "game.tnt.primed", 1.0F, 1.0F);
            }
        }
    }
