...
public class PoisonGhast extends EntityGhast {
	...
	public PoisonGhast(World world) {
		super(world);
	}
	...
	public void shoot() {
		...
		EntityPoisonFireball fireball = new EntityPoisonFireball(this.worldObj, this, dx, dy, dz);
